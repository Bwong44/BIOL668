...
pbmc.data <- Read10X(data.dir = "/Users/brandonwong/Downloads/RCode/BIOL668/FINAL/filtered_gene_bc_matrices/hg19/") #Used hard path because the tutorial did
...
#saveRDS(pbmc, file = "../output/pbmc_tutorial.rds") #change output to save output
``` 
